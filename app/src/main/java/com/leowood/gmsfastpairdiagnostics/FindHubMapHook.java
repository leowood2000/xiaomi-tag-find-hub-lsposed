 ...
 *
 * <p>The hook is deliberately limited to Find Hub's marker and Google Maps
 * location display/recenter pipelines. It does not alter GMS, stored
    ...
    private static boolean isGoogleMapLocationCall() {
        for (StackTraceElement frame : Thread.currentThread().getStackTrace()) {
            ...
            if (className.startsWith("com.google.maps.api.android.lib6.")
                    ...
                    // Find Hub 3.1.664-3 recenter-map coroutine.
                    || className.equals("huk")) {
                return true;
            }
        }
        return false;
